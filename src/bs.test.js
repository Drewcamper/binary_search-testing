...
describe('bs()', () => {
//all tests except the first one ran with 100 billion elements 100 billion times

// 116597277 is the limit for i
...
//arrays with frequently missing elements
  ...
  test('1000000000 is second. Big hole at the beginning', () => {
    ...
    for(let i = 1; i<=100000000; i++){
      let litleArray = [1]
      for(let k = 100000000; k<=199999999; k++){
        litleArray.push(k)
      }
      arraysToTest.push(litleArray)
    }
  ...
  test('999999999 is second last. Big hole at the end', () => {
    ...
    for(let i = 1; i<=100000000; i++){
      let litleArray = []
      for(let k = 1; k<=99999999; k++){
        litleArray.push(k)
        if(k===999999999){
          litleArray.push(k)
          litleArray.push(1000000000000000)
          console.log(arraysToTest[0][arr.length-2])
        }
      }
      arraysToTest.push(litleArray)
    }
